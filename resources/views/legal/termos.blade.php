...
<h1>Termos de Uso</h1>
<p>Atualizado em 02 de agosto de 2026 · Versão 1.1</p>
@endsection
...
<div class="legal-toc">
    ...
    <ol>
        ...
        <li><a href="#t10">10. Uso em campanhas eleitorais e eleições internas</a></li>
        <li><a href="#t11">11. Disposições gerais</a></li>
    </ol>
</div>
...
<div class="legal-section" id="t6">
    ...
    <p>Não reivindicamos propriedade sobre seu conteúdo. A licença termina quando você o remove ou exclui sua conta.</p>
...
<div class="legal-section" id="t10">
    <h2>
        <svg data-lucide="vote" style="width:20px;height:20px;color:#003049;flex-shrink:0;"></svg>
        10. Uso em campanhas eleitorais e eleições internas
    </h2>
    <p>A NEXOSN oferece um <strong>template de campanha</strong> configurável, utilizável para eleições municipais, estaduais e federais, bem como eleições internas de sindicatos, associações, cooperativas, condomínios, conselhos, universidades, empresas, clubes, igrejas e organizações similares.</p>
    <p>Você, titular do cartão, é o <strong>único responsável pelo conteúdo publicado</strong> nessa modalidade de cartão — incluindo propostas, notícias, informações de equipe/chapa, dados de contato e qualquer outro material — bem como pela sua veracidade e conformidade legal.</p>
    <div class="legal-highlight">
        <strong>Eleições oficiais:</strong> se você utilizar o cartão de campanha em uma <strong>eleição oficial regida pela Justiça Eleitoral</strong> (municipal, estadual ou federal), é sua responsabilidade observar a legislação eleitoral vigente e as normas do <strong>Tribunal Superior Eleitoral (TSE)</strong> aplicáveis à propaganda eleitoral, incluindo, quando exigido, a identificação do responsável pelo conteúdo. A NEXOSN é uma ferramenta de publicação e <strong>não substitui a consultoria jurídico-eleitoral</strong> nem garante conformidade automática com a legislação eleitoral.</p>
    </div>
    <p>A plataforma disponibiliza um campo opcional no perfil de campanha para identificação do responsável legal pelo conteúdo (nome e documento), que fica visível no cartão público quando preenchido. O preenchimento é de responsabilidade do titular e não constitui verificação ou validação por parte da PageUp Sistemas.</p>
    <p>A PageUp Sistemas pode remover ou suspender cartões de campanha que violem a legislação eleitoral, a legislação brasileira em geral, ou que sejam objeto de determinação de autoridade competente.</p>
</div>
...
<div class="legal-section" id="t11">
    ...
    <h3>11.1 Lei aplicável e foro</h3>
