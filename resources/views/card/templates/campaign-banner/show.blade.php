...
@section('card_colors')
    ...
    <style>
        /* Banner: capa dominante, retrato menor sobreposto à esquerda */
        .campaign-tpl-banner .campaign-cover { height: 200px; }
        .campaign-tpl-banner .campaign-header-body { text-align: left; padding-left: 20px; }
        .campaign-tpl-banner .campaign-portrait { margin: -48px 0 10px; width: 76px; height: 76px; }
        .campaign-tpl-banner .campaign-role { justify-content: flex-start; }
    </style>
@endsection

@section('content')
<div class="sections-wrap campaign-tpl-banner">
